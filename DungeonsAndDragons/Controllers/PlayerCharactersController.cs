...
namespace DungeonsAndDragons.Controllers
{
    public class PlayerCharactersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PlayerCharacterId,ActorId,Name,ClassId,ParagonPathId,EpicDestinyId,ExperiencePoints,RaceId,Age,GenderId,Height,WeightPounds,AlignmentId,DeityId,Picture")] PlayerCharacter playerCharacter)
        {
            ...
            ViewBag.AlignmentId = new SelectList(db.Alignments, "AlignmentId", "Name", playerCharacter.AlignmentId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PlayerCharacterId,ActorId,Name,ClassId,ParagonPathId,EpicDestinyId,ExperiencePoints,RaceId,Age,GenderId,Height,WeightPounds,AlignmentId,DeityId,Picture")] PlayerCharacter playerCharacter)
        {
            if (ModelState.IsValid)
            {
